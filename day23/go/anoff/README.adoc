...
After looking at all those big numbers I realized it made no sense to search the room with a precision of ``1``, so I searched for the weakest robot. The weakest robot still has a signal strength of `49977702` so I could raster my room with almost factor `50,000,000` less precision. Looking back at the total space to search if I reduce my precision I came up with 
